...
import Home1 from '../../assets/Home1.json'
      ...
      <Grid container direction='column'  >
        ...
        >
          ...
          >
            <Grid item>
              ...
              <Typography variant="h5"  >
                We are bringing community stocks to you. Own a part of the next big startup and help them on the way to the top.
          ...
          <Grid item container justifyContent={matchesMD ? "center" : "flex-end"} md={5}>
            <DisplayLottie animationData={Home1} style={{ maxWidth: "40em", margin: 0 }} />
          </Grid>
        </Grid>
        <Grid item>
          <Skills />
