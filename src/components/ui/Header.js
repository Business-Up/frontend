...
export default function Header(props) {
  ...
  const routes = [
    { name: "Deals", activeIndex: 0, link: '/' },
    { name: "Founders", activeIndex: 1, link: '/about' },
    { name: "Investorss", activeIndex: 2, link: '/projects' },
    { name: "Private Rounds", activeIndex: 3, link: '/contact' },
    { name: "Learn", activeIndex: 4, link: '/contact' },
    { name: "Community", activeIndex: 5, link: '/contact' },
    { name: "Contact", activeIndex: 6, link: '/contact' }
  ];
